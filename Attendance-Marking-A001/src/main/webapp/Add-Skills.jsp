			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="LogoutAdmin">LOGOUT</a></li>
		...
		<section>
			<div class="bigimga">
				...
				<div class="centerdivs">
					...
					<form method="get" action="AddSkills"
						onsubmit="return validateSkills();">

						<div class="form-group H2">
							<h2>Skill Details</h2>
						</div>
						<div class="form-group">
							<label for="skill_type">Skills</label><input type="text"
								class="form-control" name="skill_type" id="skill_type"
								placeholder="for ex. Java, AI">
						</div>
						<div class="form-group">
							<label for="S-Desc">Skill Description</label> <input type="text"
								class="form-control" name="S-Descr" id="S_Descr"
								placeholder="for ex. java Introduction.">
						</div>
